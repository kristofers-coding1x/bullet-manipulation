...
-- Removed ZIndexBehavior to fix error
...
local function updateOptimizedESP(player)
    ...
    billboard.Container.HealthBar.Size = UDim2.new(healthPercent, 0, 1, 0)
    billboard.Container.HealthBar.BackgroundColor3 = Color3.new(1 - healthPercent, healthPercent, 0)
    ...
    if visualsSettings.visibleCheck and distance < 300 then
        isVisible = isPositionVisible(humanoidRootPart.Position, character)
    end
